...
import { GET_USER_PROFILES } from '../../utils/api/userApi';
import { userColumnList } from '../../utils/table/tableColumn';
...
const UserList = () => {
  ...
  const [loading, tableData, data] = useQueryTableData(
    ...
    // pagination
    const pageLength = data?.usersByPaging.totalPages
    const currentPage = data?.usersByPaging.currentPage
  ...
  return (
    <>
      ...
      loading={loading}
       ...
       modalComponent={UserModalData}
       statusBtn
       btnTitle="account"
       image={UserImage}
       onEditClick={`/lists/user/edit_user/${modalData.id}`}
      />
